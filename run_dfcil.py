...
if __name__ == '__main__':
    ...
    torch.backends.cudnn.benchmark = True  # Enables auto-tuning for best cuDNN algorithm
    torch.backends.cudnn.deterministic = False  # Ensure flexibility in algorithm selection
