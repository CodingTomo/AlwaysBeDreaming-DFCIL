...
class ResNet(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.relu = nn.ReLU(inplace=True)
        #self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1) # REMOVE FOR CIFAR as RESNET32 does
        ...
        self.last = nn.Linear(self.num_features, num_classes)
...
def cl_lite_resnet18_cifar(out_dim, pretrained=False, **kwargs):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], num_classes=out_dim, **kwargs)
    if pretrained:
